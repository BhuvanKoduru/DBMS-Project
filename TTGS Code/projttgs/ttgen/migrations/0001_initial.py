    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desig', models.CharField(choices=[('Prof.', 'Prof'), ('Asst. Prof', 'Asst. Prof'), ('Associate Prof', 'Associate Prof')], max_length=25)),
            ],
        ),
        migrations.CreateModel(
            name='MeetingTime',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('r_type', models.CharField(choices=[('Theory', 'Theory'), ('Lab', 'Lab')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Section',
